...
class EpicKitchensDataset(Dataset):
    ...
    def __init__(self, path_to_data, num_frames, testing=False, transform=None):
        ...
        self.path_to_tensors = TENSOR_OUTPUT_DIR
        ...
        # Calculate num_classes dynamically from the *filtered* annotations
        self.num_classes = self.annotations['verb_class'].max() + 1
        print(f"Found {self.num_classes} unique verb classes (max index {self.num_classes - 1}).")
