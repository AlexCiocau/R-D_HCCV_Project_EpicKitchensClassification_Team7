...
# --- Configuration ---
ANNOTATION_FILE = './EPIC-KITCHENS/annotations/epic_validation_split.csv'
...
transform = T.Compose([
    # Resize the *smaller* edge of the frame to 112 (640x360 -> 199x112)
    T.Resize(112), 
    # Crop the 112x112 square from the center (e.g., 199x112 -> 112x112)
    T.CenterCrop(112),
    T.ToTensor(),
