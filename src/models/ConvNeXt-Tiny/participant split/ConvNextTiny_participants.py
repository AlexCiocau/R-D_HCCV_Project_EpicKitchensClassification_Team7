"""
==============================================================================
VARIANT: PARTICIPANT SPLIT TRAINING
==============================================================================
filename: ConvNextTiny_participants.py

[PURPOSE]
Trains ConvNeXt-Tiny specifically on the Participant Split.
Includes stronger regularization and domain generalization augmentations 
(like Grayscale and Gaussian Blur) to prevent overfitting to specific kitchens.
==============================================================================
"""
